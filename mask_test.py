...
# 创建创建一个存储检测结果的dir
result_path = './static/mask_results'
...
if __name__ == '__main__':
    ...
    for filename in os.listdir(path):        
        ...
        file.write('\n')
        #r_image.show() 显示检测结果
        if label.find('nomask')>=0 :
            image_save_path = './static/mask_results/result_' + str(index) + '.jpg'       
